...
function activate_invitation_modal(modal, form) {
	...
	$('#resend_button', modal).on('click', function () {
		send_instruction(form, { email: email }, 'config_member', 'invite_resend', function () {
console.log('Resend accepted');
		});
	});

	$('#remove_button', modal).on('click', function () {
		send_instruction(form, { email: email }, 'config_member', 'invite_remove', function () {
...
function activate_invite_add(form) {
	...
	button.on('click', function () {
		...
		send_instruction(form, { emails: emails.val() }, 'config_member', 'invite_new', function (answer) {
